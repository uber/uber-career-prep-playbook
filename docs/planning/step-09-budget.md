# Step 9 — Confirm Program Budget

<span class="step-badge">Step 9 of 17</span>

???+ abstract "Action"
    Refine cost areas; review and manage a budget tracker.
...
???+ question "Considerations"
    - Is the program budget in alignment with other similar company program budgets?
    - Who is the responsible budget stakeholder?
    - Will program charges be required for the budget sponsor?

---

[:material-arrow-left: Step 8](step-08-workshop-dates.md){ .md-button } [Step 10 :material-arrow-right:](step-10-recruiting-strategy.md){ .md-button .md-button--primary }
